...
class SettingsPrivate
{
  public:
    ...
    SettingsCore::ItemBool *itemRightToLeft;
  ...
  : SettingsCore( config )
{
  ...
  d->itemRightToLeft = new SettingsCore::ItemBool( currentGroup(), QLatin1String( "RightToLeft" ), d->rightToLeft,  true  );
  addItem( d->itemRightToLeft, QLatin1String( "RightToLeft" ) );
...
void Settings::setRightToLeft( bool v )
{
      if (!self()->isImmutable( QString::fromLatin1( "RightToLeft" ) ))
        self()->d->rightToLeft = v;
}

bool Settings::rightToLeft()
{
  return self()->d->rightToLeft;
}
