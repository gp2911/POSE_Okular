...
void Part::setupActions()
{
    ...
    m_rightToLeft = ac->add<KToggleAction>("right_to_left");
    m_rightToLeft->setText(i18n( "Right To Left"));
    connect( m_rightToLeft, SIGNAL(toggled(bool)), this, SLOT(slotRightToLeftToggled(bool)) );
    m_rightToLeft->setChecked( Okular::Settings::rightToLeft() );
    slotRightToLeftToggled();
    //modification ends
    */
...
void Part::slotRightToLeftToggled( bool on )
{
